...
(async()=>{
  ...
  assert.strictEqual(result.startupReady,true,'Startup-Guard wurde nicht auf bereit gesetzt');
  ...
  if(browserErrors.length)console.log('BROWSER_ERRORS',JSON.stringify(browserErrors,null,2));
  await browser.close();
