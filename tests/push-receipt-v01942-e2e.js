...
const sw=fs.readFileSync(path.join(__dirname,'..','release','v0.19.42','site','service-worker.js'),'utf8');
...
console.log('PUSH RECEIPT V0.19.42: OK – kanonischer Release protokolliert displayed/opened/dismissed an die aktive Subscription.');
