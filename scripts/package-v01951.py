...
m['releaseNotes']=[
    'Fehler & Diagnose: kein endloses Laden mehr',
    '12-Sekunden-Timeout und verständliche Supabase-/Anmeldefehler',
    'Erneut-versuchen-Funktion direkt im Diagnosefenster',
    'Fallback-Tabelle, falls TableCore verzögert lädt',
    'Smartphone-Diagnose robuster und cache-sicher aktualisiert'
]
...
Path('release/current.json').write_text(json.dumps({
    'app':'KC DP2','version':'0.19.51','mode':'verified-direct-site','baseVersion':'0.19.50','previousVersion':'0.19.50','releasePath':'release/v0.19.51/site'
},ensure_ascii=False,indent=2)+'\n',encoding='utf-8')
(out/'RELEASE.txt').write_text('KC DP2 V0.19.51\n================\n\nDiagnose-Hotfix: Fehlerprotokoll lädt robust mit Timeout, Retry und Fallback-Tabelle.\n',encoding='utf-8')
