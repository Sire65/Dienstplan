...
const extras=[
  ...
  ['src/adapters/wish-import.js',true,true],
  ['src/adapters/xlsx-local.js',true,true],
  ['src/ui/role-ux.js',true,true],
...
const forceRefreshPaths=new Set([
  ...
  'src/adapters/wish-import.js',
  'src/adapters/xlsx-local.js',
  'src/ui/role-ux.js',
