...
const forceRefreshPaths=new Set(['index.html','src/ui/diagnostics-center.js','src/ui/diagnostics-center.css','src/core/supabase-connection-monitor.js','src/ui/diagnostics-history-view.js','src/ui/excel-migration-center.js','src/ui/session-mobile-hotfix.js','src/ui/session-diagnostics-guard.js','src/ui/kc-ux-polish.js']);
