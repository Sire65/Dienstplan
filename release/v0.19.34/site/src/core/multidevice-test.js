(function(){
 ...
 K.multiDeviceTest={version:'0.19.34',state,identity,deviceId,register,refresh,rename,createRun,joinRun,queueOfflineProbe,queueConflictProbe,sendQueued,snapshot};
