...
# Release version bump in web runtime only.
...
# Replace V0.19.4 appended login scene with final V0.19.5 scene.
...
body.ux-login .ux-login-shell:before,body.ux-login .ux-login-shell:after{content:"";position:absolute;top:0;bottom:0;width:34%;z-index:-1;background-repeat:no-repeat;background-size:100% auto;filter:saturate(.98) contrast(1.01)}
body.ux-login .ux-login-shell:before{left:0;background-image:linear-gradient(to right,rgba(20,14,10,.02),rgba(20,14,10,.22)),url("../../assets/kc-login-left.webp");background-position:left top}
body.ux-login .ux-login-shell:after{right:0;width:36%;background-image:linear-gradient(to left,rgba(20,14,10,.02),rgba(20,14,10,.18)),url("../../assets/kc-login-right.webp");background-position:right top}
body.ux-login .ux-login-card{width:min(610px,calc(100% - 18px));background:rgba(255,251,247,.975);backdrop-filter:blur(8px);border:1px solid rgba(255,255,255,.82);box-shadow:0 28px 70px rgba(0,0,0,.28);border-radius:30px;padding:23px 28px 18px;z-index:3}
...
@media(max-width:950px){body.ux-login .ux-login-shell{width:calc(100vw - 16px);min-height:calc(100dvh - 16px);margin:8px auto;padding:14px;border-radius:24px}body.ux-login .ux-login-shell:before{width:43%;opacity:.82}body.ux-login .ux-login-shell:after{width:43%;opacity:.82}body.ux-login .ux-login-card{width:min(600px,calc(100% - 8px));padding:21px 22px 17px}}
@media(max-width:650px){body.ux-login .ux-login-shell{padding:8px;background:linear-gradient(135deg,#2a2019,#1d1713)}body.ux-login .ux-login-shell:before,body.ux-login .ux-login-shell:after{opacity:.36;width:56%;background-size:auto 100%}body.ux-login .ux-login-card{padding:18px 16px 14px;border-radius:23px}body.ux-login .ux-logo-banner{width:min(200px,66%);height:108px}body.ux-login .ux-brand .ux-club{font-size:clamp(25px,7vw,34px);margin-bottom:15px}body.ux-login .ux-login-card h1{font-size:clamp(22px,7vw,32px)}body.ux-login .ux-login-divider{display:none}}
'''
p.write_text(s+css,encoding='utf-8')

# V0.19.5 no longer uses the old full-screen image with embedded login elements.
old=root/'assets/kc-login-startbild.webp'
