(function(){
 ...
 async function transportDiagnosis(url){
   ...
   try{const r=await fetch(url+'/auth/v1/settings?kc_dp_transport='+Date.now(),{method:'GET',mode:'no-cors',cache:'no-store',kcTimeoutMs:3000});d.projectNoCors=!!r;}
