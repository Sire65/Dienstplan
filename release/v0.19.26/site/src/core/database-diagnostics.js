(function(){
  ...
  K.databaseDiagnostics={version:'0.19.26',state,measureLocal,runPerformanceSuite,markStartup,markLogin,runSupabaseSuite,gradeLatency,snapshot,setDeviceName};
})();
