(function(){
  const K=window.KCDP;
  const PROJECT_ID='KC_DP3_LOCAL',DB_NAME='KC_DP3_SECURE_V020_B213_ISOLATED_1',STORE='encrypted_envelopes',META_KEY='__kc_dp3_local_crypto_meta_v2__',FORMAT='KC_DP3_LOCAL_V2',ITERATIONS=310000;
