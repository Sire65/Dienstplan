...
const checks=[
 ...
 ['neues UI wird geladen',html.includes('src/ui/wish-sprint.js?v=0.19.28')],
 ['kein VAPID Private Key im Browser',!wish.includes('VAPID_PRIVATE')&&!push.includes('VAPID_PRIVATE')],
 ['Version im Update-Manifest',manifest.version==='0.19.28'],
 ...
 ,['Antippen und Rasterziehen',read('src/ui/app.js').includes('quickPlanPointerDown')&&read('src/ui/app.js').includes('Im Raster ziehen')]
 ,['Schnellplanung als Alternative',read('src/ui/app.js').includes('Schnell einplanen')&&read('src/ui/app.js').includes('quickPlanCandidate')]
