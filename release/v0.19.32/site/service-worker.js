/* KC-DP2 stable PWA/update engine V1.
   ...
   './src/adapters/storage.js?v=0.19.32'
   ...
   './src/adapters/supabase-provider.js?v=0.19.32'
   ...
   './src/ui/role-ux.js?v=0.19.32'
   './src/core/update-manager.js?v=0.19.32'
   './src/ui/update-ui.js?v=0.19.32'
   './src/ui/app.js?v=0.19.32'
