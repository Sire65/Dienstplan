(function(){
  ...
  function humanize(){
    ...
    const m=document.getElementById('messageText');if(m&&/kompakte Plansteuerung|V0\.17\.10|V0\.19\.42/.test(m.textContent||''))m.textContent='KC DP2 V0.19.48 – Dienstplanung bereit.';
    document.title='KC DP2 V0.19.48 · Köcheclub Werne';
  }
  ...
  K.kcUxPolish={version:'0.19.48',apply,updateSaveState};
})();