(function(){
  ...
  function humanize(){
    ...
    const m=document.getElementById('messageText');if(m&&/kompakte Plansteuerung|V0\.17\.10|V0\.19\.42|V0\.19\.51|V0\.19\.52|V0\.19\.53|V0\.19\.54/.test(m.textContent||''))m.textContent='KC DP2 V0.19.56 – Dienstplanung bereit.';
    document.title='KC DP2 V0.19.56 · Köcheclub Werne';
  }
  ...
  K.kcUxPolish={version:'0.19.56',apply,updateSaveState,loadV01955Modules,clearLegacyDiagnosticsState,installEarlyDiagnosticsGate,installNotificationGate,ensureSupabaseCloseX};
})();
