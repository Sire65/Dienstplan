(function(){
  ...
  function startDiagnosticsThroughV5(){
    ...
    const launch=()=>{
      ...
      alert('Fehlerdiagnose kann nicht gestartet werden: Diagnose-Controller V5 ist nicht geladen. Bitte KC DP2 neu starten.');
    };
    setTimeout(launch,0);
  }
  ...
  function loadV01955Modules(){
    loadModule('src/core/diagnostics-controller-v5.js?v=0.19.55-diag-controller-v5-1','KCDP_DIAG_CONTROLLER_V5');
