(function(){
  ...
  K.sessionMobileHotfix={version:'0.19.68-clean-leds-startguard-ui',apply,hardClose,isSessionModal,loadLoginTrace,loadDiagnosticsWatchdog,collapseStartGuard,manageStartGuardBadge};
