...
if(Number(manifest.build)!==84)failures.push(`Falscher Build im Manifest: ${manifest.build}`);
if(!manifest.cacheName.endsWith('-b84'))failures.push(`Falscher Cache-Name: ${manifest.cacheName}`);
