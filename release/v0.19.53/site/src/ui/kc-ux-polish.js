(function(){
  ...
  function humanize(){
    ...
    const m=document.getElementById('messageText');if(m&&/kompakte Plansteuerung|V0\.17\.10|V0\.19\.42|V0\.19\.51/.test(m.textContent||''))m.textContent='KC DP2 V0.19.52 – Dienstplanung bereit.';
    document.title='KC DP2 V0.19.52 · Köcheclub Werne';
  }
  ...
  K.kcUxPolish={version:'0.19.52',apply,updateSaveState};
})();
