(function(){
  ...
  function snapshot(inputDay=null){
    ...
    return {version:'0.19.42',day:day?.date||null,overall,people,manager,context,checkedAt:new Date().toISOString()};
  }
