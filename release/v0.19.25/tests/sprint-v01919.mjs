...
const checks=[
 ...
 ['neues UI wird geladen',html.includes('src/ui/wish-sprint.js?v=0.19.25')],
 ['kein VAPID Private Key im Browser',!wish.includes('VAPID_PRIVATE')&&!push.includes('VAPID_PRIVATE')],
 ['Version im Update-Manifest',manifest.version==='0.19.25'],
 ...
 ['Z getrennt von Standbesetzung',read('src/core/planning.js').includes("const special=allActive.filter(s=>s.zone==='special')")&&read('src/core/planning.js').includes("const active=allActive.filter(s=>s.zone!=='special')")],
