(function(){
  ...
  K.databaseDiagnostics={version:'0.19.18',state,measureLocal,runPerformanceSuite,markStartup,markLogin,runSupabaseSuite,gradeLatency,snapshot,setDeviceName};
})();
